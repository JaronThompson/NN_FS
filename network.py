...
class Network(object):
    ...
    def __init__(self, NF, nodes=10, cost=QuadraticCost):
    ...
    def fit(self, X, Y, epochs=150, mini_batch_size=10, eta=1, lmbda=.5,
        ...
        return self.SGD(training_data, epochs, mini_batch_size, eta, lmbda,
                evaluation_data,
                patience,
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            if monitor_evaluation_cost:
                ...
                if cost > np.mean(evaluation_cost):
                    patience_count += 1
